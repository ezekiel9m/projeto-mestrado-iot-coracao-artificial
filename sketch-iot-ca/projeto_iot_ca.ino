...
#include <SPI.h>
  ...
  */
  ...
  const char* END_POINT_POST_SEND = "http://127.0.0.1:8000/notification/send/FN567899";
  const char* END_POINT_GET = "http://127.0.0.1:8000/network/FN567899";
  const char* END_POINT_GET_DATA = "http://127.0.0.1:8000/datas/list_datas_analyse";
  ...
  const char* IDENTIFIER = "FN567899"; 
